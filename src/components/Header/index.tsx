...
export const Header: React.FC = () => {
  return (
    <header style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${weddingImg})` }} className="relative w-full h-dvh flex justify-center items-center bg-cover bg-center">
