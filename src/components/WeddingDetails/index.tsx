        ...
        <div ref={weddingProgramSectionRef} className="flex flex-col items-center mb-22 max-[500px]:mb-17">
          ...
          <div className="w-full flex flex-wrap justify-center gap-16 mb-22 max-[500px]:mb-17">
            <div className="max-w-87.5 min-w-50 flex flex-1/3 flex-col items-center gap-2">
              ...
              <p className="italic text-[24px] text-white text-shadow-1 mb-2 max-[770px]:text-[22px]">11:30</p>
            ...
            <div className="max-w-87.5 min-w-50 flex flex-1/3 flex-col items-center gap-2">
              ...
              <p className="italic text-[24px] text-white text-shadow-1 mb-2 max-[770px]:text-[22px]">16:00</p>
            ...
            <div className="max-w-87.5 min-w-50 flex flex-1/3 flex-col items-center gap-2">
              ...
              <p className="italic text-[24px] text-white text-shadow-1 mb-2 max-[770px]:text-[22px]">17:45</p>
        ...
        <div ref={countdownSectionRef} className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-[770px]:gap-1.5 mb-22 max-[500px]:mb-17">
            {Object.keys(countdown).map(timePart => {
              ...
              return (
                <div key={timePart} className="size-32.5 flex flex-col justify-center items-center gap-2 border-3 border-white rounded-full max-[970px]:size-27.5 max-[770px]:size-20 max-[380px]:size-16">
