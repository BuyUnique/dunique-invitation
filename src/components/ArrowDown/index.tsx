...
const Component: React.FC<Props> = ({ onClick, className }) => {
  return (
    <button onClick={onClick} className={clsx("size-17.5 flex justify-center items-center rounded-full transition-all hover:bg-black/30 animate-arrow-move", className)}>
